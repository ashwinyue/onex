...
import (
	...
	"github.com/ashwinyue/onex/internal/onexctl/cmd"
)
...
func main() {
	...
	onexctl := cmd.NewDefaultOneXCtlCommand()
	genYaml(onexctl, "", outDir)
	for _, c := range onexctl.Commands() {
		genYaml(c, "onexctl", outDir)
	}
}
