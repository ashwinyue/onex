...
//go:generate mockgen -self_package github.com/ashwinyue/onex/internal/usercenter/store -destination mock_store.go -package store github.com/ashwinyue/onex/internal/usercenter/store IStore,SecretStore,UserStore
